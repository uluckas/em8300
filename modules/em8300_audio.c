...
unsigned digital_mute_pattern[] = {
    0x10,0x1000010,0x2000050,0x1000050,0x2000010,0x1000010,0x2000010,
    ...
    0x1000010,0x2000010,0x1000010,0x2000010,0x1000010,0x2000010,
    0x1000010,0x2000010,0x1000010,0x2000010,0x1000010,0x2000010,
    0x1000010,0x2000010,0x1000010,0x2000010,0x1000010
};
...
int em8300_audio_setup(struct em8300_s *em) {
	...
	em8300_writeregblock(em, 2*ucregister(Mute_Pattern), digital_mute_pattern, 0x600);
    }    
    return 0;
}
